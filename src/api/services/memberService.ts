...
export interface SummaryHeader {
  RC: string;
  TokenNo: string;
  Message?: string; // Added Message field from new response
}
...
// ==========================
// Updated: Member Classifications Interfaces for NEW structure
// ==========================
export interface MemberClassMain {
  Class: string;
}

export interface MemberClassData {
  Class: string;
  YesterdayCount: number;
  YesterdayCapital: number;
  YesterdayBor: number;
...
export interface MemberClassificationsDetails {
  Main: MemberClassMain;
  [key: string]: MemberClassMain | MemberClassData; // dynamic keys like 0,1,2,3
}
